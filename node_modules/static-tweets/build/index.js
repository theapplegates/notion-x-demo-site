...
var vercelFetch = require('@vercel/fetch');
...
var vercelFetch__default = /*#__PURE__*/_interopDefaultLegacy(vercelFetch);
...
var fetch = vercelFetch__default['default']();
...
.use(raw__default['default']) // Add syntax highlighting
...
const getProcessor = unified__default['default']().use(parse__default['default']) // Sanitize the HTML
