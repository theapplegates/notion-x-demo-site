...
/* harmony import */ var react_notion_x__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8639);
/* harmony import */ var _lib_notion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4740);
/* harmony import */ var _components_NotionPage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8718);
/* harmony import */ var _lib_config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8082);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([notion_utils__WEBPACK_IMPORTED_MODULE_2__, _lib_notion__WEBPACK_IMPORTED_MODULE_3__, _components_NotionPage__WEBPACK_IMPORTED_MODULE_4__, react_notion_x__WEBPACK_IMPORTED_MODULE_6__]);
([notion_utils__WEBPACK_IMPORTED_MODULE_2__, _lib_notion__WEBPACK_IMPORTED_MODULE_3__, _components_NotionPage__WEBPACK_IMPORTED_MODULE_4__, react_notion_x__WEBPACK_IMPORTED_MODULE_6__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const getStaticProps = async (context)=>{
    ...
    const recordMap = await _lib_notion__WEBPACK_IMPORTED_MODULE_3__.getPage(pageId);
    return {
        props: {
            recordMap
        },
...
async function getStaticPaths() {
    if (_lib_config__WEBPACK_IMPORTED_MODULE_5__/* .isDev */ .r8) {
        return {
            paths: [],
            fallback: true
        };
    }
    const mapPageUrl = (0,react_notion_x__WEBPACK_IMPORTED_MODULE_6__/* .defaultMapPageUrl */ .Hp)(_lib_config__WEBPACK_IMPORTED_MODULE_5__/* .rootNotionPageId */ .AM);
    // This crawls all public pages starting from the given root page in order
    // for next.js to pre-generate all pages via static site generation (SSG).
    // This is a useful optimization but not necessary; you could just as easily
    // set paths to an empty array to not pre-generate any pages at build time.
    const pages = await (0,notion_utils__WEBPACK_IMPORTED_MODULE_2__.getAllPagesInSpace)(_lib_config__WEBPACK_IMPORTED_MODULE_5__/* .rootNotionPageId */ .AM, _lib_config__WEBPACK_IMPORTED_MODULE_5__/* .rootNotionSpaceId */ .bY, _lib_notion__WEBPACK_IMPORTED_MODULE_3__.getPage.bind(_lib_notion__WEBPACK_IMPORTED_MODULE_3__), {
...
function Page({ recordMap  }) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_NotionPage__WEBPACK_IMPORTED_MODULE_4__/* .NotionPage */ .m, {
        recordMap: recordMap,
        rootDomain: _lib_config__WEBPACK_IMPORTED_MODULE_5__/* .rootDomain */ .MB,
        rootPageId: _lib_config__WEBPACK_IMPORTED_MODULE_5__/* .rootNotionPageId */ .AM,
        previewImagesEnabled: _lib_config__WEBPACK_IMPORTED_MODULE_5__/* .previewImagesEnabled */ .SK
    });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [895,202,272], () => (__webpack_exec__(9081)));
